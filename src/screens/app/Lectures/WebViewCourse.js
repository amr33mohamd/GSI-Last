...
class WeebView extends Component {
    constructor(props){
        ...
        this.state={
            ...
            url:Server.url+'api/courses/join?user_id=',
            user_id: this.props.user.id,
            amount: this.props.navigation.state.params.amount,
            courses: this.props.navigation.state.params.courses,
            installment: this.props.navigation.state.params.installment,
            total_amount:this.props.navigation.state.params.total_amount
        }
    }
                  ...
                  <Container style={{flex:1}}>
                    <Header hasTabs noShadow
                        ...
                        <Body>
                          ...
                          <WebView
                             source={{uri: this.state.url + this.state.user_id + '&amount='+this.state.amount+ '&courses'+ this.state.courses +'&installment='+this.state.installment+'&total_amount='+this.state.total_amount}}
